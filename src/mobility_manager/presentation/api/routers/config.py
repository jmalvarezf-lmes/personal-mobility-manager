...
from mobility_manager.config import get_osm_tile_url, get_toyota_locale
...
def get_config() -> ConfigResponse:
    ...
    return ConfigResponse(osm_tile_url=get_osm_tile_url(), toyota_locale=get_toyota_locale())
